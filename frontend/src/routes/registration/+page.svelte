<script>
    ...
    import {login, register} from '$lib/backend.js'
            ...
            <form class="flex flex-col space-y-6" use:form method="post">
                ...
                <Label class="space-y-2">
                    ...
                    <input class="block w-full disabled:cursor-not-allowed disabled:opacity-50 rtl:text-right p-2.5 focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 dark:focus:ring-primary-500 bg-gray-50 text-gray-900 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 border-gray-300 dark:border-gray-600 text-sm rounded-lg"
                           placeholder="nome@esempio.com" type="email" name="email" use:validators={[required, email]}
                           required/>
                </Label>
                <HintGroup for="email">
                    <Hint on="required">
                ...
                <Label class="space-y-2">
                    <span>Nome</span>
                    <input class="block w-full disabled:cursor-not-allowed disabled:opacity-50 rtl:text-right p-2.5 focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 dark:focus:ring-primary-500 bg-gray-50 text-gray-900 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 border-gray-300 dark:border-gray-600 text-sm rounded-lg"
                           placeholder="nome" type="text" name="username" use:validators={[required]} required/>
                </Label>
                ...
                <Label class="space-y-2">
                    ...
                    <input class="block w-full disabled:cursor-not-allowed disabled:opacity-50 rtl:text-right p-2.5 focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 dark:focus:ring-primary-500 bg-gray-50 text-gray-900 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 border-gray-300 dark:border-gray-600 text-sm rounded-lg"
                           placeholder="•••••" type="password" name="passwordConfirmation"
                           use:validators={[required, passwordMatch]} required/>
                </Label>
                ...
                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                    Hai già un account? <a href="/login"
                                           class="font-medium text-primary-600 hover:underline dark:text-primary-500">Accedi
                    ora!</a>
                </div>
            </form>
